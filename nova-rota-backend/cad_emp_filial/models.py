...
class EmpresaFilial (models.Model):
    ...
    CNPJ = models.CharField("CNPJ", max_length=18, null=False, unique=True)
    cod_empresa = models.CharField("Codigo Empresa", max_length=25, null=False, unique=True)
    empresa_principal = models.ForeignKey(Empresa, on_delete=models.CASCADE, default="Selecione", blank=False)
